...
public class IconPickerIndex {
    ...
    private readonly List<int> iconRange = Enumerable.Range(0, 350_000).ToList();
    ...
    private void ApplyHardcodedCategories() {
        ...
        ApplyIconCategory(19_600..19_800, "Actions", "Event");
        ApplyIconCategory(19_800..20_000, "Actions", "Mount");
        ...
        ApplyIconCategory(54_000..54_225, "Items", "Belts");
        ApplyIconCategory(54_225..54_400, "Items", "Flowers");
        ApplyIconCategory(54_400..58_000, "Items", "Equipment");
        ApplyIconCategory(58_000..58_500, "Items", "Fashion");
        ApplyIconCategory(58_500..59_000, "Items", "Chocobo Barding");
        ...
        ApplyIconCategory(62_000..62_600, "Icons", "Classes/Jobs");
        ...
        // ApplyIconCategory(63_200..63_875, "Textures", "Zone Maps");
        ApplyIconCategory(63_875..63_900, "Textures", "Cosmic Exploration");
        ApplyIconCategory(63_900..64_000, "System", "Map Markers");
        ApplyIconCategory(64_200..64_325, "Actions", "Free Company");
        ApplyIconCategory(64_500..64_550, "Icons", "Group Pose"); // Stamps 1
        ApplyIconCategory(64_550..64_600, "Icons", "Occult Crescent"); // Stamps 1
        ...
        // ApplyIconCategory(69_000..70_000, "Textures", "Footprints");
        ApplyIconCategory(70_000..70_120, "Actions", "Chocobo Racing");
        ApplyIconCategory(70_120..70_200, "Icons", "Island Sanctuary");
        // ApplyIconCategory(70_200..70_500, "Textures", "DoH/DoL Logs");
        ApplyIconCategory(70_500..70_960, "Icons", "Cosmic Exploration 2");
        ApplyIconCategory(70_960..71_450, "Icons", "Quests");
        ...
        ApplyIconCategory(82_080..82_200, "Icons");
        ApplyIconCategory(82_200..82_270, "Icons", "Occult Crescent 2");
        ApplyIconCategory(82_270..83_000, "Icons");
        ApplyIconCategory(83_000..84_000, "Icons", "Grand Company");
        // ApplyIconCategory(84_000..85_000, "Textures", "Hunts");
        // ApplyIconCategory(85_000..87_000, "Textures", "UI");
        ApplyIconCategory(87_000..90_000, "Icons", "Triple Triad");
        ...
        ApplyIconCategory(200_000..210_000, "Items", "Glasses");
        ApplyIconCategory(210_000..230_000, "Statuses"); // 229_962
        ApplyIconCategory(230_000..230_850, "Icons", "GPose");
        ApplyIconCategory(231_000..240_000, "Icons", "GPose 2");


        ApplyIconCategory(246_000..250_000, "Actions", "Emotes");
        ...
        ApplyIconCategory(250_000..251_001, "Aesthetics");
    }
